Plot4 <- function() {
     ...
     plot(subdata$Time,subdata$Global_active_power,type="l",xaxt="n",xlab = "", ylab = "Global Active Power")
     axis.POSIXct(1,subdata$Time, format="%a")
     
     plot(subdata$Time,subdata$Voltage,type="l",xaxt="n",xlab = "datetime", ylab = "Voltage")
     axis.POSIXct(1,subdata$Time, format="%a")
     ...
     plot(subdata$Time,subdata$Global_reactive_power,type="l",xaxt="n",xlab = "datetime", ylab = "Global_reactive_power")
     axis.POSIXct(1,subdata$Time, format="%a")
